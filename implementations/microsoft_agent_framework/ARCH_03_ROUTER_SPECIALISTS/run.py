"""Microsoft Agent Framework implementation for ARCH_03_ROUTER_SPECIALISTS."""
...
def run_architecture(
    ...
    """Execute a router-specialists Microsoft Agent Framework-style workflow."""

    def execute() -> MicrosoftAgentFrameworkRunOutput:
        agent = build_agent(
            name="router_specialists_workflow",
            instructions=(
                "You are a controlled router/specialists benchmark agent. "
        ...
        def run_phase(phase: str) -> None:
            ...
            step = AgentStep(
                ...
                actor=f"microsoft_agent_framework.{phase}",

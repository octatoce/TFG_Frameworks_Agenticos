"""Run the shared ARCH_01 smoke case for all implemented frameworks."""
...
def build_smoke_case() -> ExperimentInput:
    return ExperimentInput(
        ...
        metadata={"purpose": "arch01_smoke_test"},
    )


def build_config(framework: str) -> ExperimentConfig:
    return ExperimentConfig(
        experiment_id="arch01-smoke",
        run_id="arch01-smoke-001",
        framework=framework,
        ...
        metadata={
            ...
            "notes": "Deterministic local LLM for ARCH_01 smoke comparability.",
        },
    )

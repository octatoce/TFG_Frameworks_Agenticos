"""Run the shared ARCH_01 smoke case for LangGraph and CrewAI."""
    ...
    return ExperimentInput(
        ...
        documents=[
            DocumentInput(
                ...
                metadata={"source": "synthetic_smoke_case"},
            )
        ],
        evaluation_criteria={
            "expected_contains": ["frameworks agenticos", "schemas", "metricas", "JSON"]
        },
        metadata={"purpose": "iteration_1_arch01_smoke_test"},
    )


def build_config(framework: str) -> ExperimentConfig:
    return ExperimentConfig(
        experiment_id="iter1-arch01-smoke",
        run_id="iter1-arch01-smoke-001",
        framework=framework,
        architecture=ARCHITECTURE,
        model_provider="local",
        model_name="deterministic-react-v1",
        temperature=0.0,
        ...
        metadata={
            ...
            "notes": "Deterministic local LLM for iteration 1 smoke comparability.",
        },
    )

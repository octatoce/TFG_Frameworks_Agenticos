"""Run the shared ARCH_02 smoke case for all implemented frameworks."""
...
def build_smoke_case() -> ExperimentInput:
    return ExperimentInput(
        ...
        metadata={"purpose": "arch02_smoke_test"},
    )


def build_config(framework: str) -> ExperimentConfig:
    return ExperimentConfig(
        experiment_id="arch02-smoke",
        run_id="arch02-smoke-001",
        framework=framework,
        ...
        metadata={
            ...
            "notes": "Deterministic local LLM for ARCH_02 smoke comparability.",
        },
    )
